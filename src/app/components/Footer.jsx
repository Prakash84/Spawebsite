    ...
    <div className="min-w-0">
      ...
      <ul className="space-y-4 text-gray-400">
        <li className="flex items-start">
          ...
          <a href="tel:+917042889753" className="hover:text-amber-400">+91 7042889753</a>
        </li>
        <li className="flex items-start">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-3 text-amber-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
          </svg>
          <a href="mailto:info@delhibodyspa.com" className="hover:text-amber-400">dmspadelhi@gmail.com</a>
        </li>
      </ul>
    </div>
  </div>
