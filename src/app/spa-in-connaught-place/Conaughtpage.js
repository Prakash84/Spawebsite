...
const SERVICES_LEFT = [
  {
    id: 'foreigner',
    title: 'Pick Your Favourite Massage Style',
    subtitle: 'International therapists for authentic treatments',
    desc:
      "Start with the question of which one is more appropriate to your purpose, i.e., B2B, Couple’s, or Full Body massage.",
  ...
  },
  {
    ...
    desc:
      "Contact the experts at Spa Delhi by making a direct or a safe Telegram call and tell them your favorite hotel and style of treatment.",
    chips: [
...
const SERVICES_RIGHT = [
  {
    id: 'top',
    title: 'Receive Fast Appointment Confirmation',
    subtitle: 'Sustainable + award-winning',
    desc:
      "Once you decide and connect, staff confirm your slot instantly so you know when to expect your session.",
  ...
  {
    id: 'packages',
    title: 'Arrive For Your Therapy',
    subtitle: 'Premium in-room & home journeys',
    desc:
      "Show up at the hotel at the agreed time. Professional therapists guide you through the whole process, so all that’s left to do is relax.",
...
const topSteps = [
    ...
    },
    {
      ...
      title: 'Superior Oils And Safe Practices',
      text: 'The spa relies on the finest oils and operates according to the most sensible cleanliness policies, which makes them both relaxing and secure.',
    },
    {
      icon: <FaPhoneAlt className="text-amber-700 text-xl" />,
      title: 'Round-The-Clock Appointment Support',
      text: 'A customer can book or get the services anytime throughout the day or night, hence a relaxing moment is never out of reach.',   
    },
  ]
  ...
  const bottomSteps = [
    ...
    },
    {
      ...
      title: 'Health-Focused Therapies',
      text: 'Each appointment is set up not just to calm you, but to give real improvement in body and mind.',
    },
  ]
  return (
    <main>
                                           ...
                                           <div className="space-y-8">
                                             ...
                                             >
                                               <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                                 <div>
                                                   <h4 className="text-2xl font-bold">Book Your Luxury Massage at Connaught Place Today!</h4>
                                                   <p className="mt-2 opacity-95">
                                                     Visit Spa Delhi, as it is one of the finest hotels in Connaught Place. Feel refreshed, feel completely comfortable, and call Spa Delhi when you're ready for your next pampering experience.
                                                   </p>
                                                 </div>
            ...
            <div className="max-w-6xl mx-auto px-6">
              ...
              <header className="text-center mb-14">
                ...
                <p className="mt-4 text-gray-700 max-w-2xl mx-auto text-sm md:text-base">
                  Spa Delhi offers a mix of comfort, skill, and wellness in Connaught Place’s top hotels. Treatments focus on helping each client recover, recharge, and <span className="font-semibold text-amber-700">improve total health.</span>
                </p>
              </header>
